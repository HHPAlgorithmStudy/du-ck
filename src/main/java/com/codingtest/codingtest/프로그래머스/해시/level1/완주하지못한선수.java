...
public class 완주하지못한선수 {
    ...
    public static void main(String[] args) {
        ...
        String result = solution.solution2(new String[]{"mislav", "stanko", "mislav", "ana"}, new String[]{"stanko", "ana", "mislav"});
        //["leo", "kiki", "eden"], ["eden", "kiki"]
        //String result = solution.solution2(new String[]{"leo", "kiki", "eden"}, new String[]{"eden", "kiki"});
        ...
        public String solution2(String[] participant, String[] completion) {
            ...
            for (int i = 0; i < completion.length; i++) {
                if (!participant[i].equals(completion[i])) {
                    //정렬했을때 서로 다르면 참가자 배열 쪽 item 이 완주를 못한사람
                    return participant[i];
                }
            }

            //마지막 index 가 완주를 못했을 경우 대비
