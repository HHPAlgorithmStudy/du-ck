...
public class 폰켓몬 {
    ...
    public static void main(String[] args) {
        ...
        int result = solution.solution(new int[]{1,2,3,6,2,4,3,2,4,5});
    ...
    static class Solution {
        int solution(int[] nums) {
            ...
            answer = (list.size() < count) ? list.size() : count;
    ...
    /**
     * 채점 후 다른 사람들의 참고할만한 코드
     *
     * Hashset 을 사용하면 add 시 자동으로 중복 key 를 없애면서 추가한다.
     * list 대신 HashSet을 썼다면 71 line 을 없앨 수 있음.
     *
     * O(n)
     */
}
